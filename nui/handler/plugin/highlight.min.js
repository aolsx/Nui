...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}}());hljs.registerLanguage("typescript",function(){"use strict"
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("css",function(){"use strict";return function(e){var n={
...
begin:"{",end:"}",illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
